...
namespace C2dTutorial1_BasicSprites
{
    ...
    public class AppDelegate : CCApplication
    {
        ...
        public override bool ApplicationDidFinishLaunching()
        {
            ...
            CCScene gameScene = new BasicSpritesScene();
        ...
        /// <summary>
        /// The function is called when the application enters the background.
        /// </summary>
        ...
        /// <summary>
        /// The function is called when the application enters the foreground.
        /// </summary>
